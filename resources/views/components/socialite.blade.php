...
<div class="flex items-center justify-center">
    ...
    <x-jet-social-button href="{{ route('socialite.show', ['provider' => 'facebook']) }}" color="#1778F2;">
    ...
    @if(\Laravel\Jetstream\JetStream::hasSocialiteSupportFor('google'))
        <x-jet-social-button href="{{ route('socialite.show', ['provider' => 'google']) }}" >
    ...
    @if(\Laravel\Jetstream\JetStream::hasSocialiteSupportFor('twitter'))
        <x-jet-social-button href="{{ route('socialite.show', ['provider' => 'twitter']) }}" color="#00acee">
            <svg class="w-6 h-6 mx-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    @if(\Laravel\Jetstream\JetStream::hasSocialiteSupportFor('linkedin'))
        <x-jet-social-button href="{{ route('socialite.show', ['provider' => 'linkedin']) }}" color="#0e76a8">
            <svg class="w-6 h-6 mx-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    @if(\Laravel\Jetstream\JetStream::hasSocialiteSupportFor('github'))
        <x-jet-social-button href="{{ route('socialite.show', ['provider' => 'github']) }}">
            <svg class="w-6 h-6 mx-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    @if(\Laravel\Jetstream\JetStream::hasSocialiteSupportFor('gitlab'))
        <x-jet-social-button href="{{ route('socialite.show', ['provider' => 'gitlab']) }}">
    ...
    @if(\Laravel\Jetstream\JetStream::hasSocialiteSupportFor('bitbucket'))
        <x-jet-social-button href="{{ route('socialite.show', ['provider' => 'bitbucket']) }}">
