...
<div class="flex items-center justify-center">
    ...
    @if(\Laravel\Jetstream\JetStream::hasSocialiteSupportFor('facebook'))
        <x-jet-social-button color="#1778F2;">
            <svg class="w-6 h-6 mr-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    @if(\Laravel\Jetstream\JetStream::hasSocialiteSupportFor('google'))
        <x-jet-social-button>
            <svg class="w-6 h-6 mr-4" viewBox="0 0 533.5 544.3" xmlns="http://www.w3.org/2000/svg">
    ...
    @if(\Laravel\Jetstream\JetStream::hasSocialiteSupportFor('twitter'))
        <x-jet-social-button color="#00acee">
            <svg class="w-6 h-6 mr-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    @if(\Laravel\Jetstream\JetStream::hasSocialiteSupportFor('linkedin'))
        <x-jet-social-button color="#0e76a8">
            <svg class="w-6 h-6 mr-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    @if(\Laravel\Jetstream\JetStream::hasSocialiteSupportFor('gitlab'))
        <x-jet-social-button>
            <svg class="w-6 h-6 mr-4" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" viewBox="0 0 24 24">
    ...
    @if(\Laravel\Jetstream\JetStream::hasSocialiteSupportFor('bitbucket'))
        <x-jet-social-button>
            <svg class="w-6 h-6 mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
