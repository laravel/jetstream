    ...
    <x-slot name="content">
        <div dusk="logout-other-browser-sessions">
            ...
            <div class="flex items-center mt-5">
                <x-jet-button dusk="logout-other-browser-sessions-button"
            ...
            <x-jet-dialog-modal wire:model="confirmingLogout">
                ...
                <x-slot name="content">
                    ...
                    <div class="mt-4" x-data="{}" x-on:confirming-logout-other-browser-sessions.window="setTimeout(() => $refs.password.focus(), 250)">
                        <x-jet-input type="password" dusk="logout-other-browser-sessions-confirmation-password"
                ...
                <x-slot name="footer">
                    ...
                    <x-jet-button dusk="logout-other-browser-sessions-confirmation-button"
                                    class="ml-2"
