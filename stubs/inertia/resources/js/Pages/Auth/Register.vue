    ...
    <JetAuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature" class="mt-4">
                <JetLabel for="terms">
                    <div class="flex items-center">
                        ...
                        <div class="ml-2">
                            I agree to the
                            <a target="_blank" :href="route('terms.show')" class="underline text-sm text-gray-600 hover:text-gray-900">Terms of Service</a> and
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <JetButton class="ml-4" :class="{ 'opacity-25': form.processing }" :disabled="form.processing"> Register </JetButton>
            </div>
        </form>
    </JetAuthenticationCard>
</template>
