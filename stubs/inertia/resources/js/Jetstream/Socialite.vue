<template>
    <div>
        ...
        <div class="flex items-center justify-center">
            <!-- Facebook -->
            <jet-social-button v-if="socialiteServices.includes('facebook')" :href="route('socialite.show', {'provider': 'facebook'})" color="#1778F2;">
            ...
            <!-- Google -->
            <jet-social-button v-if="socialiteServices.includes('google')" :href="route('socialite.show', {'provider': 'google'})" >
            ...
            <!-- Twitter -->
            <jet-social-button v-if="socialiteServices.includes('twitter')" :href="route('socialite.show', {'provider': 'twitter'})" color="#00acee">
                <svg class="w-6 h-6 mx-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- LinkedIn -->
            <jet-social-button v-if="socialiteServices.includes('linkedin')" :href="route('socialite.show', {'provider': 'linkedin'})" color="#0e76a8">
                <svg class="w-6 h-6 mx-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- GitHub -->
            <jet-social-button v-if="socialiteServices.includes('github')" :href="route('socialite.show', {'provider': 'github'})">
                <svg class="w-6 h-6 mx-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- GitLab -->
            <jet-social-button v-if="socialiteServices.includes('gitlab')" :href="route('socialite.show', {'provider': 'gitlab'})">
            ...
            <!-- Bitbucket -->
            <jet-social-button v-if="socialiteServices.includes('bitbucket')" :href="route('socialite.show', {'provider': 'bitbucket'})">
