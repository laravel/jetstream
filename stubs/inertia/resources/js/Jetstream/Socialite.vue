<template>
    <div>
        ...
        <div class="flex items-center justify-center">
            <!-- Facebook -->
            <jet-social-button v-if="socialiteProviders.includes('facebook')" :href="route('socialite.redirect', {'provider': 'facebook'})" color="#1778F2;">
            ...
            <!-- Google -->
            <jet-social-button v-if="socialiteProviders.includes('google')" :href="route('socialite.redirect', {'provider': 'google'})" >
            ...
            <!-- Twitter -->
            <jet-social-button v-if="socialiteProviders.includes('twitter')" :href="route('socialite.redirect', {'provider': 'twitter'})" color="#00acee">
                <svg class="w-6 h-6 mx-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- LinkedIn -->
            <jet-social-button v-if="socialiteProviders.includes('linkedin')" :href="route('socialite.redirect', {'provider': 'linkedin'})" color="#0e76a8">
                <svg class="w-6 h-6 mx-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- GitHub -->
            <jet-social-button v-if="socialiteProviders.includes('github')" :href="route('socialite.redirect', {'provider': 'github'})">
                <svg class="w-6 h-6 mx-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- GitLab -->
            <jet-social-button v-if="socialiteProviders.includes('gitlab')" :href="route('socialite.redirect', {'provider': 'gitlab'})">
            ...
            <!-- Bitbucket -->
            <jet-social-button v-if="socialiteProviders.includes('bitbucket')" :href="route('socialite.redirect', {'provider': 'bitbucket'})">
...
<script>
import JetSocialButton from '@/Jetstream/SocialButton';
