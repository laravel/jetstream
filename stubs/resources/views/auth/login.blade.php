        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4" x-data="{ showPassword: false }">
                ...
                <div class="relative mt-1 flex items-center">
                    <x-jet-input id="password" class="block w-full pr-12" x-bind:type="showPassword ? 'text' : 'password'" id="password" name="password" required autocomplete="current-password" />
