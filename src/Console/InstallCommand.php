...
class InstallCommand extends Command
{
    ...
    protected function installLivewireStack()
    {
        ...
        // Components ..
        (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/livewire/resources/views/components', resource_path('views/vendor/jetstream/components'));
        (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/livewire/resources/views/mail', resource_path('views/vendor/jetstream/mail'));
